...
import se.getqte.model.repository.PartRoleRepository;

@RestController
@RequestMapping(value = "/partrole")
public class PartRoleController extends ControllerCRUD {


    @Autowired
    public PartRoleController(PartRoleRepository repository){
